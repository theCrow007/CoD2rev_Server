...
unsigned short scr_const_sound_file_done;
unsigned short scr_const_sound_file_stop;
...
void RegisterLibcodDvars()
{
	...
	g_spawnMapWeapons = Dvar_RegisterBool("g_spawnMapWeapons", true, DVAR_CHANGEABLE_RESET);
	g_spawnMapTurrets = Dvar_RegisterBool("g_spawnMapTurrets", true, DVAR_CHANGEABLE_RESET);
	g_playerCollisionEjectDuration = Dvar_RegisterInt("g_playerCollisionEjectDuration", 300, 0, 32000, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
	g_playerCollisionEjectDamageAllowed = Dvar_RegisterBool("g_playerCollisionEjectDamageAllowed", false, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
	sv_maxSnapshotEntities = Dvar_RegisterInt("sv_maxSnapshotEntities", MAX_SNAPSHOT_ENTITIES, 32, MAX_SNAPSHOT_ENTITIES, DVAR_ARCHIVE | DVAR_LATCH);
	g_spectateBots = Dvar_RegisterBool("g_spectateBots", true, DVAR_CHANGEABLE_RESET);
	sv_downloadMessageAtMap = Dvar_RegisterBool("sv_downloadMessageAtMap", true, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
	sv_downloadNotifications = Dvar_RegisterBool("sv_downloadNotifications", false, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
	sv_botReconnectMode = Dvar_RegisterInt("sv_botReconnectMode", 0, 0, 2, DVAR_CHANGEABLE_RESET);
	sv_authorizeServer = Dvar_RegisterString("sv_authorizeServer", AUTHORIZE_SERVER_NAME, DVAR_ARCHIVE | DVAR_LATCH);
	sv_authorizePort = Dvar_RegisterInt("sv_authorizePort", PORT_AUTHORIZE, 0, 65535, DVAR_ARCHIVE | DVAR_LATCH);
	sv_authorizeTimeout = Dvar_RegisterInt("sv_authorizeTimeout", AUTHORIZE_TIMEOUT, 0, 60000, DVAR_ARCHIVE);
	sv_noauthorize = Dvar_RegisterBool("sv_noauthorize", false, DVAR_ARCHIVE | DVAR_LATCH);
	...
	sv_kickGamestateLimitedClients = Dvar_RegisterBool("sv_kickGamestateLimitedClients", false, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
	sv_reservedConfigstringBufferSize = Dvar_RegisterInt("sv_reservedConfigstringBufferSize", 0, 0, 16000, DVAR_ARCHIVE | DVAR_CHANGEABLE_RESET);
