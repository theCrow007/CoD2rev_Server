...
#ifdef LIBCOD
	scr_const_bot_trigger = GScr_AllocString("bot_trigger"); // libcod: sv_botUseTriggerUse
	scr_const_sound_file_done = GScr_AllocString("sound_file_done"); // libcod: playSoundFile
	scr_const_sound_file_stop = GScr_AllocString("sound_file_stop"); // libcod: playSoundFile
#endif
